                ...
                <div>
                    ...
                    <div class="mt-2 flex flex-wrap gap-2">
                        ...
                        <span
                            ...
                            <i class="fas {{ $statusIcons[$pengaduan->status] }} mr-1"></i>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                @foreach($pengaduan->fotoPendukung as $foto)
                                    <div class="relative group">
                                        <a href="{{ asset('storage/' . $foto->path) }}" target="_blank" class="block">
                                            <img src="{{ asset('storage/' . $foto->path) }}" alt="{{ $foto->nama_file }}"
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white shadow rounded-lg">
                        ...
                        <div class="px-6 py-5">
                            <ol class="relative border-l border-gray-200">
                                ...
                                <li class="mb-6 ml-4">
                                    <div
                                        class="absolute w-3 h-3 bg-green-600 rounded-full mt-1.5 -left-1.5 border border-white">
                                    </div>
                                ...
                                @if(in_array($pengaduan->status, ['diproses', 'selesai']))
                                    <li class="mb-6 ml-4">
                                        ...
                                        <time class="mb-1 text-sm font-normal leading-none text-gray-400">
                                            {{ \Carbon\Carbon::parse($pengaduan->tanggal_pengaduan)->addDay()->format('d M Y') }}
                                        </time>
                                ...
                                @if($pengaduan->status == 'selesai')
                                    <li class="ml-4">
                                        ...
                                        <time class="mb-1 text-sm font-normal leading-none text-gray-400">
                                            {{ \Carbon\Carbon::parse($pengaduan->tanggal_pengaduan)->addDays(2)->format('d M Y') }}
                                        </time>
                    ...
                    <!-- Feedback Admin -->
                    <div class="bg-white shadow rounded-lg">
                        <div class="px-6 py-4 border-b border-gray-200 {{ $pengaduan->feedback ? 'bg-green-50' : '' }}">
                            <h3 class="text-lg font-medium text-gray-900">
                                <i
                                    class="fas fa-comment-dots mr-2 text-{{ $pengaduan->feedback ? 'green' : 'gray' }}-600"></i>
                                Feedback
                                {{ $pengaduan->feedback ? 'Admin' : '' }}
                            </h3>
                        </div>
                        <div class="px-6 py-5">
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <div class="text-xs text-gray-500">
                                            {{ \Carbon\Carbon::parse($pengaduan->feedback->tanggal_feedback)->format('d M Y H:i') }}
                                        </div>
                            ...
                            @else
                                <div class="text-center">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">Admin akan memberikan feedback setelah meninjau
                                        pengaduan</p>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="px-6 py-5">
                            <div class="space-y-3">
                                ...
                                @if($pengaduan->status == 'baru')
                                    <form action="{{ route('siswa.pengaduan.destroy', $pengaduan) }}" method="POST"
